...
class MigrationListController extends Controller
{
    private $route;
    ...
    public function index(Request $request): View
    {
        ...
        $migrations = $query->select('id', 'migration', 'batch')->paginate($perPage)->appends($request->all());
        ...
        $route = $this->route;
        return view('jiny-admin::migrations.list', compact('migrations', 'stats', 'sort', 'dir', 'route', 'batches'));
    }
    ...
    public function show($id): View
    {
        ...
        $columns = null;
        if ($tableName && \Illuminate\Support\Facades\Schema::hasTable($tableName)) {
        ...
        return view('jiny-admin::migrations.show', compact('migration', 'route', 'tableName', 'columns'));
    }
} 