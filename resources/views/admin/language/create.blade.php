...
@section('title', '언어 추가')
@section('description', '시스템에서 지원하는 언어를 추가합니다. 언어명, 코드, 국기, 국가, 회원수, 비율 등을 관리할 수 있습니다.')

@section('heading')
<div class="w-full">
    <div class="sm:flex sm:items-end justify-between">
        <div class="sm:flex-auto">
            <h1 class="text-2xl font-semibold text-gray-900">언어 추가</h1>
            <p class="mt-2 text-base text-gray-700">새로운 언어 정보를 입력하고 등록하세요.</p>
        </div>
...
@section('form')
    <x-ui::form-section title="기본 정보" description="언어의 기본 정보를 입력하세요.">
