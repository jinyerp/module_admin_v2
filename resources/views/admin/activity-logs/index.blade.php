...
@section('title', '관리자 활동 로그 목록')
@section('description', '관리자 활동 로그를 확인하고 관리할 수 있습니다.')
    ...
    <div class="w-full">
        <div class="sm:flex sm:items-end justify-between">
            <div class="sm:flex-auto">
                ...
                <p class="mt-2 text-base text-gray-700">관리자 활동 로그를 확인하고 관리할 수 있습니다. 관리자의 다양한 활동, IP 주소, 액션 등을 추적할 수 있습니다.</p>
            </div>
...
@section('content')
    ...
    <div class="mt-6 bg-white rounded-lg border border-gray-200 p-4">
        <div id="filter-container" class="space-y-4">
            ...
            @includeIf('jiny-admin::admin.activity-logs.filters')
                ...
                data-even="{{ $loop->even ? '1' : '0' }}">
                    ...
                    <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500">
                        <a href="{{ route($route . 'show', $item->id) }}" class="text-gray-500 hover:text-indigo-600">
                            {{ $item->adminUser->name ?? $item->admin_user_id }}
                        </a>
                    </td>
                    ...
                    <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500">
                        <code class="text-xs bg-gray-100 px-2 py-1 rounded">{{ $item->ip_address }}</code>
                    </td>
                    ...
                    <td class="relative py-4 pr-4 pl-3 text-right text-sm font-medium whitespace-nowrap sm:pr-3">
                        <div class="flex items-center justify-end gap-2">
                            ...
                            <a href="{{ route($route.'edit', $item->id) }}"
                                ...
                                <span class="sr-only">Edit log {{ $item->id }}</span>
                            </a>
                            <span
                                ...
                                <span class="sr-only">Delete log {{ $item->id }}</span>
                            </span>
                        </div>
                    </td>
                </x-ui::table-row>
