...
<div class="w-full">
    <div class="sm:flex sm:items-end justify-between">
        <div class="sm:flex-auto">
            <h1 class="text-2xl font-semibold text-gray-900">국가 수정</h1>
            <p class="mt-2 text-base text-gray-700">시스템에서 지원하는 국가 정보를 수정합니다. 국가명, 코드, 국기, 위도, 경도, 언어, 회원수, 설명, 관리자 등을 변경할 수 있습니다.</p>
        </div>
...
@section('form')
    <x-ui::form-section title="기본 정보" description="국가의 기본 정보를 수정하세요.">
        <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
            ...
            <div class="sm:col-span-3">
                ...
                <div class="mt-2 relative">
                    <input type="text" name="latitude" id="latitude" value="{{ old('latitude', $item->latitude) }}"
                        class="block w-full rounded-md bg-white px-3 py-2 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 sm:text-sm"
                        placeholder="위도" />
                </div>
            </div>
            <div class="sm:col-span-3">
                ...
                <div class="mt-2 relative">
                    <input type="text" name="longitude" id="longitude" value="{{ old('longitude', $item->longitude) }}"
                        class="block w-full rounded-md bg-white px-3 py-2 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 sm:text-sm"
                        placeholder="경도" />
                </div>
            </div>
            <div class="sm:col-span-3">
                ...
                <div class="mt-2 relative">
                    <input type="text" name="lang" id="lang" value="{{ old('lang', $item->lang) }}"
                        class="block w-full rounded-md bg-white px-3 py-2 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 sm:text-sm"
                        placeholder="언어" />
                </div>
            </div>
            ...
            <div class="sm:col-span-3">
                ...
                <div class="mt-2 relative">
                    <input type="text" name="manager" id="manager" value="{{ old('manager', $item->manager) }}"
                        class="block w-full rounded-md bg-white px-3 py-2 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 sm:text-sm"
                        placeholder="관리자" />
                </div>
            </div>
            <div class="sm:col-span-3">
                ...
                <div class="mt-2 relative">
                    <textarea name="description" id="description" rows="2"
                        class="block w-full rounded-md bg-white px-3 py-2 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 sm:text-sm"
                        placeholder="설명">{{ old('description', $item->description) }}</textarea>
                </div>
            </div>
            <div class="sm:col-span-3">
