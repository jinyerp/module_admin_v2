...
@section('content')
    ...
    <form action="{{ route('admin.system.countries.update', $country) }}" method="POST" class="mt-6" id="countryEditForm">
        ...
        <div class="space-y-12">
            <!-- 기본 정보 섹션 -->
            <x-ui::form-section title="기본 정보" description="국가의 기본적인 식별 정보입니다.">
            ...
            <!-- 지역 설정 섹션 -->
            <x-ui::form-section title="지역 설정" description="국가별 통화 및 언어 설정 정보입니다.">
                <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
                    <div class="sm:col-span-3">
            ...
            <!-- 상태 설정 섹션 -->
            <x-ui::form-section title="상태 설정" description="국가의 활성화 상태 및 기본 설정입니다.">
            ...
            <!-- 시스템 정보 섹션 (읽기전용) -->
            <x-ui::form-section title="시스템 정보" description="데이터베이스에 기록된 시스템 정보입니다.">
                <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
                    <div class="sm:col-span-3">
