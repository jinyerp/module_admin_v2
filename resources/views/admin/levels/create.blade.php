...
@section('title', '새 등급 등록')
@section('description', '새로운 등급 정보를 입력하고 등록하세요.')
                    ...
                    <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
                        <div class="sm:col-span-3">
                            <div class="flex items-center">
                                <input type="checkbox" name="can_create" id="can_create" value="1" {{ old('can_create') ? 'checked' : '' }}
                        ...
                        <div class="sm:col-span-3">
                            <div class="flex items-center">
                                <input type="checkbox" name="can_read" id="can_read" value="1" {{ old('can_read') ? 'checked' : '' }}
                                    class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" />
                        ...
                        <div class="sm:col-span-3">
                            <div class="flex items-center">
                                <input type="checkbox" name="can_update" id="can_update" value="1" {{ old('can_update') ? 'checked' : '' }}
                                    class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" />
                        ...
                        <div class="sm:col-span-3">
                            <div class="flex items-center">
                                <input type="checkbox" name="can_delete" id="can_delete" value="1" {{ old('can_delete') ? 'checked' : '' }}
                                    class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" />
