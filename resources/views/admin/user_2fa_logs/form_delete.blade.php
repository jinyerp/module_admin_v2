<div class="bg-white rounded-xl shadow-2xl p-8 w-full max-w-md border border-gray-200">
    <div class="flex items-start gap-4 mb-4">
        ...
        <div class="flex-1">
            <h3 class="text-lg font-bold text-gray-900 mb-1">2FA 로그 삭제</h3>
            <div class="text-gray-700 mb-1">
                <strong>ID: {{ $log->id ?? '' }}</strong> 2FA 로그를 삭제하시겠습니까?
            </div>
    ...
    <input type="text" id="confirm-input" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-red-400 mb-4 transition" placeholder="위의 난수키를 입력하세요" autocomplete="off">
    <div class="flex justify-end gap-2 mt-2">
        <button id="cancel-btn" type="button" class="bg-white border border-gray-300 text-gray-900 px-4 py-2 rounded hover:bg-gray-50">취소</button>
        <button id="confirm-delete-btn" type="button" disabled class="bg-gray-400 text-white px-4 py-2 rounded disabled:bg-gray-400 disabled:cursor-not-allowed">삭제</button>
    </div>
</div> 