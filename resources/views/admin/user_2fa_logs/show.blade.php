...
@section('title', '2FA 로그 상세')
@section('description', '2FA 인증 로그 상세 정보')

@section('heading')
<div class="w-full">
    <div class="sm:flex sm:items-end justify-between">
        <div class="sm:flex-auto">
            <h1 class="text-2xl font-semibold text-gray-900">2FA 로그 상세</h1>
        ...
        <div class="mt-4 sm:mt-0">
            ...
            <button type="button" 
                    id="edit-btn"
                    data-edit-url="{{ route($route.'edit', $log->id) }}"
            ...
            <button type="button" 
                    id="delete-btn"
                    data-delete-route="{{ route($route.'destroy', $log->id) }}"
...
@section('content')
    <div class="pt-2 pb-4">
        {{-- 통합된 알림 메시지 --}}
        @includeIf('jiny-admin::user_2fa_logs.alerts')
                ...
                <div class="px-4 py-6 sm:p-8">
                    <div class="grid grid-cols-1 gap-x-6 gap-y-8 lg:grid-cols-3">
                        ...
                        <div class="lg:col-span-1">
                            ...
                            <p class="mt-1 text-sm leading-6 text-gray-600">2FA 인증 로그의 기본 정보입니다.</p>
                        </div>
                        ...
                        <div class="lg:col-span-2">
                            <dl class="divide-y divide-gray-100">
                                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    ...
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{{ $log->id }}</dd>
                                </div>
                                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-sm font-medium leading-6 text-gray-900">관리자</dt>
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{{ $log->adminUser->name ?? $log->admin_user_id ?: '-' }}</dd>
                                </div>
                                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-sm font-medium leading-6 text-gray-900">이메일</dt>
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{{ $log->adminUser->email ?? '-' }}</dd>
                                </div>
                                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-sm font-medium leading-6 text-gray-900">IP 주소</dt>
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{{ $log->ip_address ?: '-' }}</dd>
                                </div>
                                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    ...
                                    <dd class="mt-1 text-sm leading-6 sm:col-span-2 sm:mt-0">
                                        ...
                                        @else
                                            <span class="text-gray-700">{{ $log->status ?: '-' }}</span>
                                        @endif
                                    </dd>
                                </div>
                                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-sm font-medium leading-6 text-gray-900">생성일시</dt>
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{{ $log->created_at ?: '-' }}</dd>
                                </div>
                                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-sm font-medium leading-6 text-gray-900">수정일시</dt>
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{{ $log->updated_at ?: '-' }}</dd>
                                </div>
                                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-sm font-medium leading-6 text-gray-900">메시지</dt>
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{{ $log->message ?: '-' }}</dd>
                                </div>
                            </dl>
                        </div>
                    </div>
            ...
            <section>
                <div class="px-4 py-6 sm:p-8">
                    <div class="grid grid-cols-1 gap-x-6 gap-y-8 lg:grid-cols-3">
                        <!-- 왼쪽: 제목과 설명 -->
                        <div class="lg:col-span-1">
                            <h3 class="text-base font-semibold leading-7 text-gray-900">액션 정보</h3>
                            <p class="mt-1 text-sm leading-6 text-gray-600">2FA 인증 로그의 액션 정보입니다.</p>
                        </div>
                        ...
                        <div class="lg:col-span-2">
                            <dl class="divide-y divide-gray-100">
                                ...
                                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    ...
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{{ $log->user_agent ?: '-' }}</dd>
                                </div>
                                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-sm font-medium leading-6 text-gray-900">요청 메서드</dt>
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{{ $log->request_method ?: '-' }}</dd>
                                </div>
                                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-sm font-medium leading-6 text-gray-900">요청 URL</dt>
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{{ $log->request_url ?: '-' }}</dd>
                                </div>
                                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-sm font-medium leading-6 text-gray-900">응답 코드</dt>
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{{ $log->response_code ?: '-' }}</dd>
                                </div>
                                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-sm font-medium leading-6 text-gray-900">처리 시간</dt>
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{{ $log->processing_time ? $log->processing_time . 'ms' : '-' }}</dd>
                                </div>
                            </dl>
                        </div>
                    </div>
            ...
            <section>
                <div class="px-4 py-6 sm:p-8">
                    <div class="grid grid-cols-1 gap-x-6 gap-y-8 lg:grid-cols-3">
                        <!-- 왼쪽: 제목과 설명 -->
                        <div class="lg:col-span-1">
                            <h3 class="text-base font-semibold leading-7 text-gray-900">메타데이터</h3>
                            <p class="mt-1 text-sm leading-6 text-gray-600">2FA 인증 관련 메타데이터를 확인할 수 있습니다.</p>
                        </div>
                        ...
                        <div class="lg:col-span-2">
                            <dl class="divide-y divide-gray-100">
                                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    ...
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                        <pre class="whitespace-pre-wrap text-xs bg-gray-50 p-2 rounded border">{{ json_encode($log->metadata, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE) }}</pre>
                                    </dd>
                                </div>
                            </dl>
                        </div>
            ...
            <section>
                <div class="px-4 py-6 sm:p-8">
                    <div class="grid grid-cols-1 gap-x-6 gap-y-8 lg:grid-cols-3">
                        <!-- 왼쪽: 제목과 설명 -->
                        <div class="lg:col-span-1">
                            <h3 class="text-base font-semibold leading-7 text-gray-900">추가 데이터</h3>
                            <p class="mt-1 text-sm leading-6 text-gray-600">2FA 인증 관련 추가 데이터입니다.</p>
                        </div>
                        ...
                        <div class="lg:col-span-2">
                            <dl class="divide-y divide-gray-100">
                                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    ...
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                        <pre class="whitespace-pre-wrap text-xs bg-gray-50 p-2 rounded border">{{ json_encode(json_decode($log->additional_data), JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE) }}</pre>
                                    </dd>
                                </div>
                            </dl>
                        </div>
