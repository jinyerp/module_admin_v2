...
<div class="w-full px-4 py-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 mb-1">백업 로그 생성</h1>
            <p class="text-gray-600">새로운 백업 로그를 생성합니다.</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <div class="p-6">
            <form method="POST" action="{{ route('admin.systems.backup-logs.store') }}">
                @csrf
                ...
                <div class="mt-6">
                    ...
                    <textarea name="error_message" id="error_message" rows="4"
                              ...
                              placeholder="오류가 발생한 경우 오류 메시지를 입력하세요">{{ old('error_message') }}</textarea>
                    @error('error_message')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
